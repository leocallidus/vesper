...
pub fn tr(language: Language, key: &'static str) -> &'static str {
    ...
    match key {
        ...
        "Показать найденные BufferA-D + Common" => "Show detected BufferA-D + Common",
        "Показать найденные BufferA-D + Common + Sound" => "Show detected BufferA-D + Common + Sound",
        "Проверить" => "Check",
        "Проверка шейдеров" => "Shader check",
        "Источник" => "Source",
        "Файл/папка" => "File/folder",
        "Шейдерпак" => "Shaderpack",
        "Шейдер" => "Shader",
        "Перетащите папку шейдерпака сюда…" => "Drop a shaderpack folder here…",
        "Или нажмите «Импортировать»." => "Or click “Import”.",
        "Импортировать шейдерпак" => "Import shaderpack",
        "Открыть папку" => "Open folder",
        "Шейдеров" => "Shaders",
        "Удалить шейдерпак?" => "Delete shaderpack?",
        "Поддерживаются только папки" => "Only folders are supported",
        "Шейдерпак уже существует" => "Shaderpack already exists",
        "Выберите действие при конфликте" => "Choose what to do with the conflict",
        "Заменить" => "Replace",
        "Переименовать" => "Rename",
        "Импортировано" => "Imported",
        "Удалено" => "Deleted",
        "Сброшен выбор GLSL шейдера" => "GLSL shader selection reset",
        "Шейдерпаки не найдены" => "No shaderpacks found",
        "В шейдерпаке нет шейдеров" => "Shaderpack has no shaders",
        ...
        "Выберите источник импорта" => "Choose import source",
        ".zip" => ".zip",
        "Импортировать .zip" => "Import .zip",
        ...
        "Системный экран блокировки" => "System lock screen",
        "При активности запускает системный экран блокировки (потребуется пароль)" => {
            "On activity, trigger the system lock screen (password required)"
        }
        ...
        "Скрыть курсор в интерактивном шейдере" => "Hide cursor in interactive shader",
        "Скорость" => "Speed",
        "Медленно" => "Slow",
        "Нормально" => "Normal",
        "Быстро" => "Fast",
